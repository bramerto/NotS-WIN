...
namespace LINQ_Demo.Data
{
    public class InternalDatabase
    {
        ...
        public InternalDatabase()
        {
            ...
            {
                new Order {id = 10, customer_id = 10, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 11, customer_id = 11, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 12, customer_id = 12, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 13, customer_id = 13, product_ids = new List<int> {Random.Next(30, 50), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 14, customer_id = 14, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 15, customer_id = 15, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 16, customer_id = 16, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 17, customer_id = 17, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 18, customer_id = 18, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 19, customer_id = 19, product_ids = new List<int> {Random.Next(30, 50), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 20, customer_id = 20, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 21, customer_id = 21, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 22, customer_id = 22, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 23, customer_id = 23, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
                new Order {id = 24, customer_id = 24, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = Random.Next(1, 7)},
            };
