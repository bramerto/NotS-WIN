    ...
    public class InternalDatabase
    {
        ...
        public InternalDatabase()
        {
            ...
            orders = new Collection<Order>
            {
                ...
                new Order {id = 13, customer_id = 13, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = 5},
                ...
                new Order {id = 19, customer_id = 19, product_ids = new List<int> {Random.Next(10, 24), Random.Next(10, 24) }, total_price = Random.Next(100, 800), discount = 0, shipping_cost = 5},
